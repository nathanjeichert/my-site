  ...
  return (
    <div className="min-h-screen pt-32 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h3 className="text-2xl font-bold text-sage mb-6">Find us on</h3>
          <div className="flex justify-center space-x-8">
            <a href="#" className="text-cream hover:text-gold transition-colors">Spotify</a>
            <a href="#" className="text-cream hover:text-gold transition-colors">Apple Music</a>
            <a href="#" className="text-cream hover:text-gold transition-colors">Bandcamp</a>
            <a href="#" className="text-cream hover:text-gold transition-colors">SoundCloud</a>
          </div>
        </motion.section>
      </div>
    </div>
